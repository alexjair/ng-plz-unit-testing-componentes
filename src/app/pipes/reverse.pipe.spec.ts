...
//import la clase pipe
import { ReservePipe } from './reverse.pipe';

/* PRUEBAS SOLO CON LAS INSTANCIAS !!! */
fdescribe('reverse.pipe.spec.ts', () => {

  describe('ReversePipe from  instace', () => {
  ...
  describe('ReservePipe from HostComponent', () => {
    ...
    it('should apply reverse pipe when typing in the input', () => {
      ...
      //Hacer que se ingrese, simule el ingro de texto.. al input
      inputEl.value = 'ANA 2'; // 2 ANA
      inputEl.dispatchEvent(new Event('input')); //se tecleo
      fixture.detectChanges(); //hace deteccion de cambios
